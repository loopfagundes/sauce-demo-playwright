...
test.describe("Login", () => {
  ...
  test("login com usuário problemático", async ({ page, login, inventory }) => {
    await login.goto();
    await login.login(
      usuario.problematico.usuario,
      usuario.problematico.senha
    );
  ...
  test("login com usuário performance glitch", async ({ page, login, inventory }) => {
    await login.goto();
    await login.login(
  ...
  test("login com usuário visual", async ({ page, login, inventory }) => {
    await login.goto();
    await login.login(
      usuario.visual.usuario,
      usuario.visual.senha
    );
